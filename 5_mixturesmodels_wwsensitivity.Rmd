---
title: "Toxic metal mixtures in wells and PTB: metal mixtures models,  well water sensitivity"
author: "Lauren Eaves"
date: "04/14/2022"
...
PTB_adj_ppb <- qgcomp.noboot(preterm~.,
                          expnms=Xnm, dat=cohort_50[,c(Xnm,covars,'preterm')], family=binomial(), q=4)
PTB_adj_ppb
plot(PTB_adj_ppb)


PTB_unadj_ppb <- qgcomp.noboot(preterm~.,
                          expnms=Xnm, dat=cohort_50[,c(Xnm,'preterm')], family=binomial(), q=4)
PTB_unadj_ppb
plot(PTB_unadj_ppb)
...
```
# PTB mixture models: partial effects 
```{r}
# training/validation split
set.seed(432789)
trainidx <- sample(1:nrow(cohort_50), round(nrow(cohort_50)*0.3))
valididx <- setdiff(1:nrow(cohort_50),trainidx)
traindata <- cohort_50[trainidx,]
validdata <- cohort_50[valididx,]
dim(traindata) 
dim(validdata)  
...
vPTB_adj_ppb <- qgcomp.noboot(verypreterm~.,
                          expnms=Xnm, dat=cohort_50[,c(Xnm,covars,'verypreterm')], family=binomial(), q=4)
vPTB_adj_ppb
plot(vPTB_adj_ppb)

vPTB_unadj_ppb <- qgcomp.noboot(verypreterm~.,
                          expnms=Xnm, dat=cohort_50[,c(Xnm,'verypreterm')], family=binomial(), q=4)
vPTB_unadj_ppb
plot(vPTB_unadj_ppb)
...
# very PTB mixture models: partial effects 
```{r}
...
ePTB_adj_ppb <- qgcomp.noboot(extremepreterm~.,
                          expnms=Xnm, dat=cohort_50[,c(Xnm,covars,'extremepreterm')], family=binomial(), q=4)
ePTB_adj_ppb
plot(ePTB_adj_ppb)

ePTB_unadj_ppb <- qgcomp.noboot(extremepreterm~.,
                          expnms=Xnm, dat=cohort_50[,c(Xnm,'extremepreterm')], family=binomial(), q=4)
ePTB_unadj_ppb
plot(ePTB_unadj_ppb)

```

# extremely PTB mixture models: partial effects 
```{r}
...
write.csv(Results_SlopeParams, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_SlopeParams_50wellwater.csv"), row.names=TRUE)
write.csv(Results_MetalCoeffs, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_MetalCoeffs_50wellwater.csv"), row.names=TRUE)
write.csv(Results_MetalWeights, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_MetalWeights_50wellwater.csv"), row.names=TRUE)
...
PTB_emm <- qgcomp.emm.noboot(preterm~ Arsenic.Mean_avg + Cadmium.Mean_avg + Lead.Mean_avg + Manganese.Mean_avg + Chromium.Mean_avg + Copper.Mean_avg +Zinc.Mean_avg + mage+ mage_sq + smoke + mothed + Nitr_perc,
           emmvar="racegp", 
           expnms = Xnm, 
           dat=cohort_50[,c(Xnm,covars,'racegp','preterm')], q=4, 
           family=binomial())
...
vPTB_emm <- qgcomp.emm.noboot(verypreterm~ Arsenic.Mean_avg + Cadmium.Mean_avg + Lead.Mean_avg + Manganese.Mean_avg + Chromium.Mean_avg + Copper.Mean_avg +Zinc.Mean_avg + mage+ mage_sq + smoke + mothed + Nitr_perc,
           emmvar="racegp", 
           expnms = Xnm, 
           dat=cohort_50[,c(Xnm,covars,'racegp','verypreterm')], q=4, 
           family=binomial())
...
ePTB_emm <- qgcomp.emm.noboot(extremepreterm~ Arsenic.Mean_avg + Cadmium.Mean_avg + Lead.Mean_avg + Manganese.Mean_avg + Chromium.Mean_avg + Copper.Mean_avg +Zinc.Mean_avg + mage+ mage_sq + smoke + mothed + Nitr_perc,
           emmvar="racegp", 
           expnms = Xnm, 
           dat=cohort_50[,c(Xnm,covars,'racegp','extremepreterm')], q=4, 
           family=binomial())
...
write.csv(Results_SlopeParams, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_SlopeParams_Racemodification_50wellwater.csv"), row.names=TRUE)
write.csv(Results_MetalCoeffs, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_MetalCoeffs_Racemodification_50wellwater.csv"), row.names=TRUE)
write.csv(Results_MetalWeights, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_MetalWeights_Racemodification_50wellwater.csv"), row.names=TRUE)
...
PTB_adj_ppb <- qgcomp.noboot(preterm~.,
                          expnms=Xnm, dat=cohort_25[,c(Xnm,covars,'preterm')], family=binomial(), q=4)
PTB_adj_ppb
plot(PTB_adj_ppb)


PTB_unadj_ppb <- qgcomp.noboot(preterm~.,
                          expnms=Xnm, dat=cohort_25[,c(Xnm,'preterm')], family=binomial(), q=4)
PTB_unadj_ppb
plot(PTB_unadj_ppb)
...
# training/validation split
set.seed(432789)
trainidx <- sample(1:nrow(cohort_25), round(nrow(cohort_25)*0.3))
valididx <- setdiff(1:nrow(cohort_25),trainidx)
traindata <- cohort_25[trainidx,]
validdata <- cohort_25[valididx,]
dim(traindata) 
dim(validdata)  
...
vPTB_adj_ppb <- qgcomp.noboot(verypreterm~.,
                          expnms=Xnm, dat=cohort_25[,c(Xnm,covars,'verypreterm')], family=binomial(), q=4)
vPTB_adj_ppb
plot(vPTB_adj_ppb)

vPTB_unadj_ppb <- qgcomp.noboot(verypreterm~.,
                          expnms=Xnm, dat=cohort_25[,c(Xnm,'verypreterm')], family=binomial(), q=4)
vPTB_unadj_ppb
plot(vPTB_unadj_ppb)
...
ePTB_adj_ppb <- qgcomp.noboot(extremepreterm~.,
                          expnms=Xnm, dat=cohort_25[,c(Xnm,covars,'extremepreterm')], family=binomial(), q=4)
ePTB_adj_ppb
plot(ePTB_adj_ppb)

ePTB_unadj_ppb <- qgcomp.noboot(extremepreterm~.,
                          expnms=Xnm, dat=cohort_25[,c(Xnm,'extremepreterm')], family=binomial(), q=4)
ePTB_unadj_ppb
plot(ePTB_unadj_ppb)
...
write.csv(Results_SlopeParams, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_SlopeParams_25wellwater.csv"), row.names=TRUE)
write.csv(Results_MetalCoeffs, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_MetalCoeffs_25wellwater.csv"), row.names=TRUE)
write.csv(Results_MetalWeights, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_MetalWeights_25wellwater.csv"), row.names=TRUE)
...
PTB_emm <- qgcomp.emm.noboot(preterm~ Arsenic.Mean_avg + Cadmium.Mean_avg + Lead.Mean_avg + Manganese.Mean_avg + Chromium.Mean_avg + Copper.Mean_avg +Zinc.Mean_avg + mage+ mage_sq + smoke + mothed + Nitr_perc,
           emmvar="racegp", 
           expnms = Xnm, 
           dat=cohort_25[,c(Xnm,covars,'racegp','preterm')], q=4, 
           family=binomial())
...
vPTB_emm <- qgcomp.emm.noboot(verypreterm~ Arsenic.Mean_avg + Cadmium.Mean_avg + Lead.Mean_avg + Manganese.Mean_avg + Chromium.Mean_avg + Copper.Mean_avg +Zinc.Mean_avg + mage+ mage_sq + smoke + mothed + Nitr_perc,
           emmvar="racegp", 
           expnms = Xnm, 
           dat=cohort_25[,c(Xnm,covars,'racegp','verypreterm')], q=4, 
           family=binomial())
...
ePTB_emm <- qgcomp.emm.noboot(extremepreterm~ Arsenic.Mean_avg + Cadmium.Mean_avg + Lead.Mean_avg + Manganese.Mean_avg + Chromium.Mean_avg + Copper.Mean_avg +Zinc.Mean_avg + mage+ mage_sq + smoke + mothed + Nitr_perc,
           emmvar="racegp", 
           expnms = Xnm, 
           dat=cohort_25[,c(Xnm,covars,'racegp','extremepreterm')], q=4, 
           family=binomial())
...
write.csv(Results_SlopeParams, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_SlopeParams_Racemodification_25wellwater.csv"), row.names=TRUE)
write.csv(Results_MetalCoeffs, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_MetalCoeffs_Racemodification_25wellwater.csv"), row.names=TRUE)
write.csv(Results_MetalWeights, paste0(Output_Folder,"/", cur_date, "_qgcomp_Results_MetalWeights_Racemodification_25wellwater.csv"), row.names=TRUE)
